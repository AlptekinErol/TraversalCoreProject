...
namespace SignalRApiForSql.Model
{
    public class VisitorService
    {
        ...
        public List<VisitorChart> GetVisitorChartList()
        {
            ...
            {
                command.CommandText = "Select tarih,[1],[2],[3],[4],[5] from(select[City], CityVisitCounter, Cast([Date] as Date) as tarih from Visitors) as visitTable Pivot(sum(CityVisitCounter) for City in([1], [2], [3], [4], [5])) as pivottable order by tarih asc"; // sql SP query
